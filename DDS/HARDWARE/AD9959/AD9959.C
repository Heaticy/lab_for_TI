...
void Write_frequence(uint8_t Channel, uint32_t Freq)
{
	  ...
	  u32 Temp;            
	  Temp=(u32)Freq*8.589934592 + 172.0 /2000000.0 * Freq;	   //将输入频率因子分为四个字节  8.589934592=(2^32)/500000000
...
//设置4个通道的频率
void AD9958_SetFrequency2Channel(u32 Freq2,u32 Freq3)
{
	Write_frequence(0,Freq2);
	Write_frequence(1,Freq3);			
}

//设置4个通道的幅度
void AD9958_SetAmp2Channel(u32 Amp2,u32 Amp3)
{
	Write_Amplitude(0,Amp2);
	Write_Amplitude(1,Amp3);			
}

//设置4个通道的相位
void AD9958_SetPhase2Channel(u32 Phase2,u32 Phase3)
{
	Write_Phase(0,Phase2);
	Write_Phase(1,Phase3);			
}
